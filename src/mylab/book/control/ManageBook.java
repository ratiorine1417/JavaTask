...
public class ManageBook {
	...
	public static void main(String[] args) {
		...
		System.out.println(String.format("%s 변경 전 가격: %d원", publications[2].getTitle(), currentPrice));
		System.out.println(String.format("%s 변경 후 가격: %d원", publications[2].getTitle(), publications[2].getPrice()));
		System.out.println(String.format("차액: %d원", currentPrice-publications[2].getPrice()));
		System.out.println("");
